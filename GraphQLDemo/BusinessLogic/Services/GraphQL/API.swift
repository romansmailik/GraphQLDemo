...
public final class GetRepositoriesByUserNameQuery: GraphQLQuery {
  ...
  public var queryDocument: String {
    ...
    document.append("\n" + NodeDetails.fragmentDefinition)
    return document
  }
      ...
      public struct Repository: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static var selections: [GraphQLSelection] {
            return [
              GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
              GraphQLFragmentSpread(NodeDetails.self),
            ]
          }
          ...
          public struct Fragments {
            ...
            public var nodeDetails: NodeDetails {
              get {
                return NodeDetails(unsafeResultMap: resultMap)
              }
              set {
                resultMap += newValue.resultMap
              }
...
public struct NodeDetails: GraphQLFragment {

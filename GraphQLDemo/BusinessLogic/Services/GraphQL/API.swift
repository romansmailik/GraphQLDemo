...
public final class GetLatestRepositoriesQuery: GraphQLQuery {
  ...
  public let operationName: String = "GetLatestRepositories"

  public var queryDocument: String {
    var document: String = operationDefinition
    document.append("\n" + RepoInfo.fragmentDefinition)
    return document
  }
      ...
      public struct Repository: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static var selections: [GraphQLSelection] {
            return [
              GraphQLField("__typename", type: .nonNull(.scalar(String.self))),
              GraphQLFragmentSpread(RepoInfo.self),
            ]
          }
          ...
          public init(id: GraphQLID, name: String, description: String? = nil, stargazerCount: Int) {
            self.init(unsafeResultMap: ["__typename": "Repository", "id": id, "name": name, "description": description, "stargazerCount": stargazerCount])
          }
          ...
          public struct Fragments {
            ...
            public var repoInfo: RepoInfo {
              get {
                return RepoInfo(unsafeResultMap: resultMap)
              }
              set {
                resultMap += newValue.resultMap
              }
...
public final class GetTopRatedRepositoriesQuery: GraphQLQuery {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
  ...
  public let operationName: String = "GetTopRatedRepositories"
...
public struct RepoInfo: GraphQLFragment {
